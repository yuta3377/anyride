...
Bike.create!(name: "CB1300SB", price: 6000, year: 2011, displacement: 1300, mileage: 25000, description: "Nice bike!", manufacture_id: 0, prefecture_id: 1, bodytype_id: 0, user_id: 0)
Bike.create!(name: "CB400", price: 3000, year: 2012, displacement: 400, mileage: 10000, description: "Nice bike!", manufacture_id: 0, prefecture_id: 1, bodytype_id: 0, user_id: 0)
Bike.create!(name: "CB750", price: 4000, year: 2015, displacement: 750, mileage: 4000, description: "Nice bike!", manufacture_id: 0, prefecture_id: 0, bodytype_id: 0, user_id: 1)
Bike.create!(name: "CB1100", price: 5000, year: 2013, displacement: 1100, mileage: 15000, description: "Nice bike!", manufacture_id: 0, prefecture_id: 0, bodytype_id: 0, user_id: 2)
